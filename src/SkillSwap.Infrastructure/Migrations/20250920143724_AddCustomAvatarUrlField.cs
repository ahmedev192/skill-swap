...
{
    /// <inheritdoc />
    public partial class AddCustomAvatarUrlField : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedReferralCode = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndorseeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Endorsements_AspNetUsers_EndorseeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditsCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupEvents_AspNetUsers_OrganizerId",
                        column: x => x.OrganizerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupEvents_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditsPerHour = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSkills_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupEventParticipants", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherConfirmed = table.Column<bool>(type: "bit", nullable: false),
                    StudentConfirmed = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sessions_UserSkills_UserSkillId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CreditTransactions_CreditTransactions_RelatedTransactionId",
            ...
            migrationBuilder.InsertData(
                table: "Badges",
                columns: new[] { "Id", "CreatedAt", "Description", "IconUrl", "IsActive", "Name", "RequiredValue", "Type", "UserId" },
                values: new object[,]
                {
                    { -9, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2383), "7-day learning streak", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Consistency King", 7, 7, null },
                    { -8, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2381), "Learned 3 different skills", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Knowledge Seeker", 3, 6, null },
                    { -7, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2380), "Received 5 reviews", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Review Magnet", 5, 4, null },
                    { -6, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2378), "Completed 10 sessions", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Session Champion", 10, 3, null },
                    { -5, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2372), "Offered 3 different skills", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Skill Master", 3, 5, null },
                    { -4, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2370), "Helped 5 different people", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Community Helper", 5, 8, null },
                    { -3, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2367), "Learned for 5 hours", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Learning Enthusiast", 5, 2, null },
                    { -2, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2364), "Taught for 10 hours", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "Teaching Pro", 10, 1, null },
                    { -1, new DateTime(2025, 9, 20, 14, 37, 23, 376, DateTimeKind.Utc).AddTicks(2349), "Completed your first teaching session", "https://cdn-icons-png.flaticon.com/512/1828/1828817.png", true, "First Session", 1, 1, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditTransactions_RelatedTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Endorsements_EndorserId_EndorseeId_SkillId",
                table: "Endorsements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupEventParticipants_GroupEventId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupEvents_OrganizerId",
                table: "GroupEvents",
                column: "OrganizerId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupEvents_SkillId",
                table: "GroupEvents",
                column: "SkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerId_SessionId",
                table: "Reviews",
